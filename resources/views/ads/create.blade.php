        ...
        <article>
            ...
            <form action="{{ route('ads.store') }}" method="post">
                ...
                <fieldset>
                    ...
                    <label>
                        Description
                        <textarea name="description" rows="3" placeholder="The charateristics of the thing you're selling, its quality etc."
                    ...
                    <label>
                        Price
                        <input type="number" name="price" placeholder="Price (MDL)" autocomplete="price" required />
                    </label>
